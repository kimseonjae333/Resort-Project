...
<body>
	...
	<div style="width: 1050px;">
		<table id='photo' cellpadding='0' cellspacing='0' width='100%'
			...
			<tr>
				<td><img
					src="${pageContext.request.contextPath}/resources/img/room1/room1.jpg"
					alt="room1"></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td><img
					src="${pageContext.request.contextPath}/resources/img/room1/room1-2.jpg"
					alt="room1-2"></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td><img
					src="${pageContext.request.contextPath}/resources/img/room1/room1-3.jpg"
					alt="room1-3"></td>
			</tr>
		</table>
	</div>
