...
<script language="JavaScript">
	function submitForm() {
		const form = document.getElementById('resvInsertForm');
		...
		if (Name.length > 30 || Depname.length > 30) {
			...
			form.action = "/sunriseResort/resv_insert";
			form.submit();
			return true;
		}
	}
...
<body>
	...
	<div style="width: 1050px;">
		<div class="insert">
			...
			<form method="post" id="resvInsertForm"
				...
				<div class="button">
					<input type="submit" value="예약"><input type="button"
						value="취소" onClick="location.href='/sunriseResort/calendar'">
				</div>
			</form>
		</div>
	</div>
