...
<script language="JavaScript">
	function checkSearch() {
		...
		if (searchKeyword.length > 20) {
			...
			form.action = '/sunriseResort/userBoard_searchNext?search=${boardItem.title}';
			form.submit();
		}
	}
</script>
			...
			<table cellspacing="0" width="800" border="1" align="center">
				...
				<c:forEach var="boardItem" items="${pages.content}">
					<tr>
						...
						<td><p class="p">
								<a href="/sunriseResort/userBoard_view?id=${boardItem.id}">
									<c:choose>
					...
					<table width="800">
						<tr>
							<td style="float: right;"><input type="text" name="search"
								...
								onclick="location.href='/sunriseResort/userBoard_list'"></td>
						</tr>
					</table>
				</form>
			</div>
